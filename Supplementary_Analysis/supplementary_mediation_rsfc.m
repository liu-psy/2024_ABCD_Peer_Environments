...
vars = mediations_rsfcs.Properties.VariableNames(2:101)';
mediations = table2array(mediations_rsfcs(:,2:101));

% PFI - 2 cortical RSFCs
...
% DFI - 20 cortico-subcortical RSFCs
